...
const jestPrismaCore = require('@quramy/jest-prisma-core');
const environments_js = require('vitest/dist/environments.js');
...
const index = {
  ...
  async setup(global, options) {
    ...
    const env = environments_js.builtinEnvironments[baseEnv ?? "node"];
    const envReturn = await env.setup(global, {});
    const delegate = new jestPrismaCore.PrismaEnvironmentDelegate(
      {
        projectConfig: {
